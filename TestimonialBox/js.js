...
const textTestimonial = document.querySelector(".text-testimonial"),
  nameAuthor = document.querySelector(".name-author"),
  imageAuthor = document.querySelector(".author-image"),
  workAuthor = document.querySelector(".work-author");
let idx = 0;
function changeTestimonials() {
  if (idx > testimonials.length - 1) {
    idx = 0;
  }
  nameAuthor.textContent = testimonials[idx].name;
  imageAuthor.src = testimonials[idx].photo;
  workAuthor.textContent = testimonials[idx].position;
  textTestimonial.textContent = testimonials[idx].text;
  idx++;
}
changeTestimonials();
setInterval(() => {
